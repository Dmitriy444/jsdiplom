...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar carousel = function carousel() {\n  var blocks = document.querySelector('.services-elements'),\n      arrows = document.querySelector('.services-arrow'),\n      cards = blocks.querySelectorAll('.col-sm-6');\n\n  for (var i = 0; i < cards.length; i++) {\n    cards[i].setAttribute('id', 'card');\n  }\n\n  cards[3].style.display = 'none';\n  cards[5].style.display = 'none';\n  cards[4].style.display = 'none';\n\n  for (var _i = 0; _i < 3; _i++) {\n    cards[_i].id = 'first';\n  }\n\n  for (var _i2 = 3; _i2 < cards.length; _i2++) {\n    cards[_i2].id = 'second';\n  }\n\n  var arrowRight = function arrowRight() {\n    for (var _i3 = 0; _i3 < 3; _i3++) {\n      cards[_i3].style.display = 'none';\n    }\n\n    for (var _i4 = 3; _i4 < cards.length; _i4++) {\n      cards[_i4].style.display = 'block';\n    }\n  };\n\n  var arrowLeft = function arrowLeft() {\n    for (var _i5 = 0; _i5 < 3; _i5++) {\n      cards[_i5].style.display = 'block';\n    }\n\n    for (var _i6 = 3; _i6 < cards.length; _i6++) {\n      cards[_i6].style.display = 'none';\n    }\n  };\n\n  arrows.addEventListener('click', function (event) {\n    var target = event.target;\n\n    if (target.matches('.arrow-right')) {\n      arrowRight();\n    } else if (target.matches('.arrow-left')) {\n      arrowLeft();\n    }\n  });\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (carousel);\n\n//# sourceURL=webpack://jsdiplom/./src/modules/carousel.js?");
